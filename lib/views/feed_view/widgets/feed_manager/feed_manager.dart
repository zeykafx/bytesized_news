...
import 'package:bytesized_news/views/feed_view/widgets/feed_manager/feed_group_tile.dart';
import 'package:bytesized_news/views/feed_view/widgets/feed_manager/feed_manager_store.dart';
import 'package:bytesized_news/views/feed_view/widgets/feed_manager/feed_tile.dart';
                                                                          ...
                                                                          : Row(
                                                                              ...
                                                                              children: [
                                                                                ...feedGroup.feeds
                                                                                    ...
                                                                                    .map(
                                                                                      (feed) =>
                                                                                          CachedNetworkImage(imageUrl: feed.iconUrl, width: 12, height: 12),
                                                                                    ),
                                                                              ],
                                                                            ),
